    ...
    <ul>
        ...
        <li><a href="#">
            ...
            <ul>
                ...
                <li><a href="../Pages/GeoLocation.aspx">
        ...
        <li><a href="../Pages/FindMyCar.aspx">
            <asp:Label ID="Label7" runat="server" Text="Find My Car"></asp:Label></a>
        </li>
        <li><a href="../Pages/FindMyCarTest.aspx">
            <asp:Label ID="Label8" runat="server" Text="Find My Car Test"></asp:Label></a>
        </li>
    </ul>
    <br style="clear: left" />
</div>
