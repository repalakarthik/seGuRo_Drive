...
<div class="FormHeader">Weather Forecast</div>
<div class="Form-Contents">
    <p>
        Enter City Name and Click on Go to get Weather Forecast</p>
    <p>
        <b>City Name</b></p>
    <input type="text" id="placename" />
    <br />
    <input type="button" id="findweather" value="Go" class="Default-Button-Style" />
</div>
    
    <div id="weatherholder">
        <table id="weathertext" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2" id="placetitle">
                </td>
            </tr>
            <tr>
                <td id="forecastimage">
                ...
                <td id="statustext">
                    ...
                    <br />
                    <span id="condition" class="contents"></span>
                    <br />
                    <span id="dirspeed" class="contents"></span>
                    <br />
