<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Root.master" AutoEventWireup="true"
    CodeBehind="FindMyCarTest.aspx.cs" Inherits="Locator.Pages.FindMyCarTest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function findCar() {
            ...
            var src = new google.maps.LatLng(srcLatitude, srclongitude);
//          var src = getLocation();
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Form-Contents">
        ...
        <input type="button" id="findCar" title="find car" style="background-color: Transparent;
            padding-right: 5px; margin: 0px; color: #0000CD; font-weight: bold; font-size: 10pt;
            cursor: pointer; float: inherit" value="Find Car" />
    </div>
